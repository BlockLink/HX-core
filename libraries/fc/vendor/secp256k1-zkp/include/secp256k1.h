...
# define SECP256K1_CONTEXT_COMMIT (1 << 11)
# define SECP256K1_CONTEXT_RANGEPROOF (1 << 12)
...
*/
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int secp256k1_ec_pubkey_decompress(
	const secp256k1_context* ctx,
